...
class SaisonRepository extends ServiceEntityRepository
{
    ...
    */
    public function findBySeason()
    {
        ...
        ->andWhere('j.numero_saison = 1')
        ->getQuery()
        ->getResult();
        // SELECT nom,numero_saison,nbr_episode FROM `saison` INNER JOIN serie ON serie_id=serie.id WHERE numero_saison=1 AND serie_id = serie.id
